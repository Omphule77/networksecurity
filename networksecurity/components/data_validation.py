...
class DataValidation:
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            if not status:
                error_message=f"Number of columns in train dataframe is not equal to the number of columns in test dataframe"
            status=self.validate_number_of_columns(test_dataframe)
            if not status:
                error_message=f"Number of columns in test dataframe is not equal to the number of columns in train dataframe"

            ## lets check the drift
